...
do
  case $optname in
    ...
    "i")
        ...
        echo -e "${BOLD}Configure environment parameters on your needs in .env.local file${NC}${NORMAL}" &&
    ...
    "c")
        ...
        d$(getDockerComposeCommandName) exec php bash bin/console cache:clear --env=${APP_ENV}
        echo -e "${GREEN}Done${NORMAL}"
        echo
        ;;
    "u")
